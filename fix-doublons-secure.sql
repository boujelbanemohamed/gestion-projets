-- CORRECTION FINALE DES DOUBLONS D'EMAILS - VERSION SECURISEE
...
-- ========================================
-- 3. STRATEGIE SECURISEE
-- ========================================

-- Au lieu de mettre a jour les references, on va :
-- 1. Supprimer d'abord les enregistrements problematiques
-- 2. Recréer les profils avec les bons IDs
-- 3. Les references FK seront automatiquement mises a jour

-- ========================================
-- 4. SUPPRESSION DES ENREGISTREMENTS PROBLEMATIQUES
-- ========================================
...
-- ========================================
-- 5. CREATION DES PROFILS AVEC LES BONS IDS
-- ========================================
...
-- ========================================
-- 7. VERIFICATION DES REFERENCES ORPHELINES
-- ========================================
